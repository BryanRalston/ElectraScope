...
export default function ProjectView({ project, onUpdate, onSelectRoom, onDeleteRoom, onScope, onPanel, onPrint, onHousePlan, flash }) {
    ...
    <div className="container">
      <div className="card">
        ...
        <div className="row" style={{ marginTop: 12 }}>
          ...
          <button className="btn-outline" onClick={onHousePlan}>House Plan</button>
